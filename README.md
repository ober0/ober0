...
### 4. AI Chat with File Support & Reminders <sub>(pet project)</sub>
<a href='https://ks54hack.ober0.ru/signin?email=test@yandex.ru&password=String_1'> <img alt="Static Badge" src="https://img.shields.io/badge/AI%20Chat%20(click)-FFD700?style=for-the-badge"> </a>

Chatbot based on OpenAI models with support for uploading both text and files. Users can communicate with AI, create notes generated by AI, and set reminders. An access system is also implemented, for example, users with the preview role cannot create reminders and they have a limit on messages.

### 5. **Machine Learning Model Builder**   <sub>(pet project)</sub>
